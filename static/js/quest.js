...
function claimQuest(questId, button) {
    ...
    fetch("/quest/claim/" + questId, { method: "POST" })
        ...
        .then(data => {
            ...
            button.innerHTML = '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#4caf50" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg> Fait';
